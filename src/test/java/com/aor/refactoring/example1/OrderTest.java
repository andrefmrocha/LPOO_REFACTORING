...
public class OrderTest {
    ...
    private Order getSmallOrder() {
        ...
        order.add(new OrderLine(new Product("Lollipop", 5), 10));
    ...
    private Order getLargeOrder() {
        Order order = new Order();
        order.add(new OrderLine(new Product("Playstation 4", 400), 2));
        order.add(new OrderLine(new Product("Red Dead Redemption 2", 50), 1));
